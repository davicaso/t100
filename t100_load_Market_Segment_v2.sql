...
-- 9.  create dimensional tables extracting data from air_oai_facts.airline_traffic_segment with column descriptions:
--  9.1. air_oai_dims.aircraft_configurations (aircraft_configuration_ref)
-- 10. create dimensional tables by pulling the data from air_oai_facts.airline_traffic_market with appropriate conditions:
...
-- 9. create dimensional tables by pulling the data from air_oai_facts.airline_flight_performance_integrated_mv with appropriate conditions:
...
-- 11. add keys and indexes
---- air_oai_dims.aircraft_configurations PK
...
---- air_oai_dims.airline_service_classes PK
